CLASS zcl_04_solution_u23 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_04_solution_u23 IMPLEMENTATION.
...
*        DATA(carrier) = new lcl_carrier(  i_carrier_id = c_carrier_id ). "" hier kommt bei Aktivierung sofort Fehlermeldung
      ...
      CATCH cx_abap_auth_check_exception INTO DATA(lx_excp). "" Für Übung 18 eingefügt
