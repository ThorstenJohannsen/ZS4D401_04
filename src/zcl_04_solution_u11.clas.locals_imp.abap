    ...
    SELECT FROM /lrn/airport
      ...
      SELECT FROM /dmo/connection
          ...
          left outer join /lrn/airport AS b
            ON /dmo/connection~airport_from_id = b~airport_id

          FIELDS carrier_id, connection_id, airport_from_id, airport_to_id, departure_time,
                 arrival_time, a~timzone as timzone_from, b~timzone as timzone_to
          INTO TABLE @connection_buffer.
            ...
            CATCH cx_root.
              SELECT SINGLE
               ...
               FIELDS carrier_id, connection_id, flight_date, plane_type_id, seats_max, seats_occupied, price, currency_code,
                     "" neu eingefügt mit Übung 11 Aufgabe 2
