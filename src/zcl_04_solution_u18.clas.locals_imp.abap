...
*    TYPES t_output TYPE c LENGTH 25. """ Länge ist mit 25deutlich zu knapp, auf 40 ändern
    ...
    METHODS constructor
      ...
      RAISING   cx_abap_invalid_value
                cx_abap_auth_check_exception. "" mit Übung 18 eingefügt, auch in Global-Class
...
CLASS lcl_carrier IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    me->carrier_id = i_carrier_id.
    """ für Übung 18 Carrier getauscht auf I_Carrier Achtung Felder heißen Anders!!
    SELECT SINGLE
...
*  FIELDS name, currency_code "" Übung 11 Aufgabe 3 auskommentiert
      ...
      FIELDS concat_with_space(  Carrier_ID , name, 1 ), currency_code "" Airline = Carrier_ID und Currency_code
     WHERE Carrier_ID = @i_carrier_id
